...
const validTypes: any = [
    {message: '邮箱格式不正确', value: 'email', pattern: /^[A-Za-z\d]+([-_.][A-Za-z\d]+)*@([A-Za-z\d]+[-.])+[A-Za-z\d]{2,4}$/},
    ...
    {message: '长度范围须在 6 到 12 之间', value: 'dataLength', pattern: /^.{6,12}$/},
    ...
    {
        message: '微信号格式不正确，需以字母开头，包含字母、数字、下划线和减号，长度 6 - 20 个字符',
        value: 'wechatId',
    ...
    },
    {
        message: '车牌号格式不正确',
        value: 'licensePlate',
        pattern: /^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼]{1}[A-HJ-NP-Z]{1}[A-HJ-NP-Z0-9]{5}$/
    },
    {
...
export function getValidType(type: any) {
    return validTypes.find((item: any) => {
