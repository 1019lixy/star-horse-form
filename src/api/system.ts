...
import {DyCompField, FieldInfo, SearchInfo, SearchParams, SelectOption, useGlobalConfigStore} from "star-horse-lowcode";
 ...
 */
export async function redirectUrlOperation(
  url: string,
 ...
 * @param value
 */
export function findNodesWithValue(
  nodes: Array<any>,
