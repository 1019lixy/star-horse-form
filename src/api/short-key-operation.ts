...
import {
    dyAltDown, dyAltLeft, dyAltRight,
    dyAltUp,
    dyBackspace,
    dyCopy, dyCtrlDown, dyCtrlLeft, dyCtrlRight, dyCtrlUp,
    dyCut, dyDelete, dyDeleteAll, dyDown,
    dyEnter,
    dyEscape, dyExchange, dyFind, dyGroup, dyLeft, dyNew, dyOpen,
    dyPaste, dyPreview, dyPrint,
    dyRedo, dyReturn, dyRight, dySave, dySelectAll,
    dyTab, dyUndo, dyUnGroup, dyUp
