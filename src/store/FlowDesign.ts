...
const dynamicFormUrl: ApiUrls = apiInstance("userdb-manage", "userdb/dynamicForm");
...
export const useFlowDesignStore = defineStore("flowDesign", () => {
    ...
    const loadDynamicForm = (id: string) => {
        postRequest(dynamicFormUrl.basePrefix + "/analysisMainTableFieldsByIds", Array.isArray(id) ? id : [id]).then((response: any) => {
