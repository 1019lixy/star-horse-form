...
export const gridContainerConfig: PageFieldInfo = {
   fieldList: [
      ...
      },
      {
         ...
         preps: {
            icon: "",
            appendList: [{ name: "FR", value: "fr" }, { name: "像素", value: "px" }, { name: "百分百", value: "%" }]
         }
      },
      {
      ...
      },
      {
         ...
         preps: {
            icon: "",
            appendList: [{ name: "像素", value: "px" }, { name: "百分百", value: "%" }]
         }
      },
      {
      ...
      },
      {
         ...
         preps: {
            icon: "",
            appendList: [{ name: "自动", value: "auto" }, { name: "FR", value: "fr" }, { name: "像素", value: "px" }, { name: "百分百", value: "%" }]
         },
      },
      {
