export default {
  ...
  "dyform.js.editor.parametersMethods": "Specific parameters or methods, switch tabs to view",
  ...
  "dbsearch.currently.shortcuts.disabled": "Currently shortcuts are disabled, table fields need to be loaded by clicking table name first",
  "dbsearch.connect.database.before.use": "Connect to database before use; if there is no data or your DB in the left dropdown, please contact admin to configure and authorize",
  "dbsearch.sql.executor.theoretically.supports": "SQL executor theoretically supports all DDL, DML, DCL operations of the database, but based on compliance, please be careful when granting operation permissions when configuring the database",
  "dbsearch.recommend.not.execute.time.consuming.sql": "It is recommended not to execute time-consuming SQL, which is easy to be intercepted by the gateway",
  "dbsearch.recommend.add.semicolon": "It is recommended to add ";" after each SQL is written to facilitate multi-SQL splitting",
  "dbsearch.default.each.sql.return.ten.records": "By default, each SQL returns a maximum of 10 records at a time, and the page supports a maximum return of 100 records configuration",
  "dbsearch.each.time.max.execute.five.sql": "The maximum number of SQL that can be executed each time cannot exceed 5, and the first 5 will be taken if exceeded",
  "dbsearch.executor.supports.selected.sql": "The executor supports executing selected SQL",
  ...
  "codegen.currently.only.support.java": "Currently only supports Java, choosing other languages will cause build failure",
  "codegen.this.property.empty": "If this property is empty, code will be generated for all database tables. If there are too many tables (>100), the program will automatically switch to asynchronous execution with build failure risk.",
  "codegen.if.this.property.empty": "If this property is empty, the generated files will include table prefixes. eg: Table: dev_userinfo, generated file: DevUserinfo.java; Multiple prefixes should be separated by semicolons (;).",
  "codegen.empty.generate.all.types": "Empty generates all file types",
  "codegen.field.visible.columns": "Form grouping is triggered when visible columns exceed the specified value, no grouping by default",
  ...
  "codegen.maven.project.module.name": "Maven project module name will be appended to package name",
  "codegen.config.file.application.name": "Corresponds to spring.application.name in application.yml config file",
  "codegen.config.file.server.port": "Corresponds to server.port in application.yml config file",
  "codegen.target.directory": "Target Directory",
  "codegen.files.deploy.server.directory": "Directory where files are deployed on server",
  ...
  "codegen.dto.files.business.files": "Whether DTO files and business files are placed in the same module",
  ...
  "userCenter.passwordSameError": "New password cannot be the same as old password",
  "userCenter.passwordMismatchError": "The two passwords entered do not match",
  "userCenter.shortcutMenuLimit": "Shortcut menu can only be set up to 10 items",
   ...
   */
  "starHorseDesign.clearCanvasConfirm": "Clear the canvas, all data will be lost, are you sure you want to clear it?",
  "starHorseDesign.deleteItemWarning": "Please select the object to delete first",
  "starHorseDesign.deleteItemConfirm": "Are you sure you want to delete the selected elements?",
  /**
   * Chart Component
   */
