    ...
    <el-card v-for="(group, k) in groups" :key="k" :headStyle="headStyle" class="card-container">
      ...
      <div class="flow-setting-item">
        ...
        <div v-if="group.approveType == 1">
          ...
          <el-radio-group :size="flowCommon.size" v-model="group.levelMode" class="w-fill">
        ...
        <div v-if="group.approveType == 2">
          ...
          <el-radio-group v-model="group.levelMode" :size="flowCommon.size" class="w-fill">
        ...
        <div v-else-if="group.approveType == 9">
          ...
          <el-radio-group v-model="group.selectType" :size="flowCommon.size" class="w-fill">
          ...
          <el-radio-group v-model="group.selectRange" :size="flowCommon.size" class="w-fill">
        ...
        <div v-else-if="group.approveType == 12">
          ...
          <el-select v-model="group.approverIds" filterable clearable :size="flowCommon.size" default-first-option>
        ...
        <div v-else-if="group.approveType == 13">
          ...
          <el-radio-group :size="flowCommon.size" class="w-fill">
