...
<template>
  <div class="flow-helper" id="flow-helper">
    ...
    <el-drawer :direction="placement" getContainer="flow-helper" :wrapStyle="wrapStyle"
               :size="scale.isMobile() ? '100%' : '300px'" :with-header="false"
               v-model="visibleHelper" @close="onClose">
      ...
      <el-popover placement="right" trigger="hover" :popper-style="{width: 'unset !important'}"
                  v-for="item in helpItemList" :key="item.idCategoryItemConfig">
        <template #reference>
    ...
    <el-drawer :direction="placement" getContainer="flow-helper" :wrapStyle="wrapStyle"
               :size="scale.isMobile() ? '100%' : '300px'" :with-header="false"
               v-model="visibleAdvice" @close="onClose">
      <div class="flow-helper-drawer-header">
    ...
    <el-drawer :direction="placement" getContainer="flow-helper" :wrapStyle="wrapStyle"
               :size="scale.isMobile() ? '100%' : '300px'" :with-header="false"
               v-model="visibleSelf" @close="onClose">
      <div class="flow-helper-drawer-header">
