        ...
        [
          {
            ...
            preps: {
              values: [
                { name: "流程变量", value: "process" },
                { name: "任务变量", value: "task" },
              ],
            },
          },
          {
            ...
            preps: {
              values: [
                { name: "内置变量", value: "inner" },
                { name: "扩展变量", value: "extend" },
              ],
            },
          },
        ],
...
<template>
  <star-horse-dialog
    :dialogVisible="processVariableVisible"
    @merge="submitVariable"
    @closeAction="onClose"
    :selfFunc="true"
    compSize="default"
    :title="'配置流程变量'"
  >
    <star-horse-form
      ...
      :fieldList="processVariablesFields"
      ref="processVariablesRef"
    />
  </star-horse-dialog>
