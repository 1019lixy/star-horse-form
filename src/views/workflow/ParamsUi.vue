<template>
      ...
      >
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.parmId'" :rules="rules.parmId" required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.parmName'" :rules="rules.parmName"
                          required>
              <el-select clearable placeholder="请选择状态" v-model="scope.row.statusCode">
                <el-option
                    :key="sitem.statusCode"
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.paramValue'" :rules="rules.paramValue"
                          required>
              <el-select clearable placeholder="请选择状态" v-model="scope.row.statusCode">
                <el-option
                    :key="sitem.statusCode"
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.paramType'" :rules="rules.paramType"
                          required>
              <el-select clearable placeholder="请选择状态" v-model="scope.row.statusCode">
                <el-option
                    :key="sitem.statusCode"
        ...
        <el-table-column
            :formatter="dataFormat"
            label="参数来源 来源于流程参数，来源于上一个节点的输出"
            min-width="200px"
            prop="paramResources"
            v-if="true "
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.paramResources'"
                          :rules="rules.paramResources" required>
              <el-select clearable placeholder="请选择状态" v-model="scope.row.statusCode">
                <el-option
                    :key="sitem.statusCode"
                    :label="sitem.statusName"
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.paramDefaultValue'"
                          :rules="rules.paramDefaultValue" required>
              <el-select clearable placeholder="请选择状态" v-model="scope.row.statusCode">
                <el-option
                    :key="sitem.statusCode"
                    :label="sitem.statusName"
  ...
  <star-horse-dialog :title="dialogTitle" :visible="dialogTableVisible" @merge="merge" @mergeDraft="mergeDraft"
                     @reset="resetForm">
    <el-form :model="ruleForm" :rules="rules" class="demo-ruleForm" ref="ruleForm">
      <el-form-item label="主键" prop="parmId" v-if="false">
        <el-input clearable placeholder="请输入主键"
                  v-model="ruleForm.parmId"></el-input>
      </el-form-item>
      ...
      <el-form-item label="参数名称" prop="parmName"
        ...
        <el-input clearable placeholder="请输入参数名称"
                  v-model="ruleForm.parmName"></el-input>
      </el-form-item>

      <el-form-item label="参数值" prop="paramValue"
                    required v-if="!false">
        <el-input clearable placeholder="请输入参数值"
                  v-model="ruleForm.paramValue"></el-input>
      </el-form-item>

      <el-form-item label="参数类型" prop="paramType"
                    required v-if="!false">
        <el-input clearable placeholder="请输入参数类型"
                  v-model="ruleForm.paramType"></el-input>
      </el-form-item>

      <el-form-item label="参数来源 来源于流程参数，来源于上一个节点的输出" prop="paramResources"
                    required v-if="!false">
        <el-input clearable placeholder="请输入参数来源 来源于流程参数，来源于上一个节点的输出"
                  v-model="ruleForm.paramResources"></el-input>
      </el-form-item>

      <el-form-item label="参数默认值" prop="paramDefaultValue"
                    required v-if="!false">
        <el-input clearable placeholder="请输入参数默认值"
                  v-model="ruleForm.paramDefaultValue"></el-input>
      </el-form-item>
  ...
  <star-horse-dialog :is-view="true" :title="'查看数据'" :visible="viewVisible">
    <el-form :model="ruleForm" class="view-ruleForm" label-width="15%" ref="ruleForm">
      <el-form-item label="主键" prop="parmId">
        <span>{{ ruleForm.parmId }}</span>
      </el-form-item>
      <el-form-item label="主键" prop="defineId">
      ...
      <el-form-item label="参数名称" prop="parmName">
        <span>{{ ruleForm.parmName }}</span>
      </el-form-item>
      <el-form-item label="参数值" prop="paramValue">
        <span>{{ ruleForm.paramValue }}</span>
      </el-form-item>
      <el-form-item label="参数类型" prop="paramType">
        <span>{{ ruleForm.paramType }}</span>
      </el-form-item>
      <el-form-item label="参数来源 来源于流程参数，来源于上一个节点的输出" prop="paramResources">
        <span>{{ ruleForm.paramResources }}</span>
      </el-form-item>
      <el-form-item label="参数默认值" prop="paramDefaultValue">
        <span>{{ ruleForm.paramDefaultValue }}</span>
      </el-form-item>
      <el-form-item label="修改人" prop="updatedBy">
...
<script setup lang="ts" name="Params">

import {ApiUrls} from "@/components/types/ApiUrls";

const dataUrl: ApiUrls = {
  loadByPageUrl: "/flow-engine/workflow/params/pageList",
  mergeUrl: "/flow-engine/workflow/params/merge",
  mergeDraftUrl: "/flow-engine/workflow/params/mergeDraft",
  batchMergeUrl: "/flow-engine/workflow/params/mergeBatch",
  batchMergeDraftUrl: "/flow-engine/workflow/params/mergeBatchDraft",
  loadByIdUrl: "/flow-engine/workflow/params/getById",
  deleteUrl: "/flow-engine/workflow/params/batchDeleteById",
  exportAllUrl: "/flow-engine/workflow/params/exportData",
  downloadTemplateUrl: "/flow-engine/workflow/params/downloadTemplate",
  userConditionUrl: "/flow-engine/workflow/params/getAllByCondition",
  importUrl: "/flow-engine/workflow/params/importData",
  uploadUrl: ""
};
