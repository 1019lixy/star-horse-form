<template>
    ...
    <el-form :model="ruleForm" :rules="rules" class="demo-ruleForm" ref="ruleForm">
      ...
      >
        ...
        <el-table-column
            ...
            label="主键"
            min-width="200px"
            prop="idProjectMember"
            v-if=" false "
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.idProjectMember'" required>
              <el-input clearable placeholder="请输入主键"
                        v-model="scope.row.idProjectMember"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.username'" required>
              <el-input clearable placeholder="请输入用户名"
                        v-model="scope.row.username"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.name'" required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.roleName'" required>
              <el-input clearable placeholder="请输入角色名称"
                        v-model="scope.row.roleName"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.effectiveDate'" required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.expirationDate'" required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.isManager'" required>
              <el-input clearable placeholder="请输入是否管理员 1是 2否"
                        v-model="scope.row.isManager"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
  ...
  <star-horse-dialog :title="dialogTitle" :visible="dialogTableVisible" @merge="merge" @mergeDraft="mergeDraft"
                     @reset="resetForm">
    <el-form :model="ruleForm" :rules="rules" class="demo-ruleForm" ref="ruleForm">
      <el-form-item label="主键" prop="idProjectMember" v-if="false">
        <el-input clearable placeholder="请输入主键"
                  v-model="ruleForm.idProjectMember"></el-input>
      </el-form-item>

      <el-form-item label="主键" prop="idprojectMember"
                    required v-if="!false">
        <el-input-number clearable placeholder="请输入主键"
                         v-model="ruleForm.idprojectMember"/>
      </el-form-item>
      ...
      <el-form-item label="角色名称" prop="roleName"
                    required v-if="!false">
        <el-input clearable placeholder="请输入角色名称"
                  v-model="ruleForm.roleName"></el-input>
      </el-form-item>
      ...
      <el-form-item label="是否管理员 1是 2否" prop="isManager"
                    required v-if="!false">
        <el-input-number clearable placeholder="请输入是否管理员 1是 2否"
                         v-model="ruleForm.isManager"/>
      </el-form-item>
  ...
  <star-horse-dialog :is-view="true" :title="'查看数据'" :visible="viewVisible">
    <el-form :model="ruleForm" class="view-ruleForm" label-width="15%" ref="ruleForm">
      <el-form-item label="主键" prop="idProjectMember">
        <span>{{ ruleForm.idProjectMember }}</span>
      </el-form-item>
      <el-form-item label="主键" prop="idprojectMember">
        <span>{{ ruleForm.idprojectMember }}</span>
      </el-form-item>
