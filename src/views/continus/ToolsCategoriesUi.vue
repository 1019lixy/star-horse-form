<template>
  <star-horse-dialog :title="dialogTitle" :visible="batchDialogTableVisible" @merge="merge"
    ...
    <el-form :model="ruleForm" :rules="rules" class="demo-ruleForm" ref="ruleForm">
      ...
      >
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.toolName'" required>
              <el-input clearable placeholder="请输入工具名称"
                        v-model="scope.row.toolName"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.toolCode'" required>
              <el-input clearable placeholder="请输入工具编码"
                        v-model="scope.row.toolCode"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.toolDesc'" required>
              <el-input clearable placeholder="请输入工具描述"
                        v-model="scope.row.toolDesc"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.toolVersion'" required>
              <el-input clearable placeholder="请输入发行版本"
                        v-model="scope.row.toolVersion"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
  ...
  <star-horse-dialog :title="dialogTitle" :visible="dialogTableVisible" @merge="merge" @mergeDraft="mergeDraft"
                     @reset="resetForm">
    <el-form :model="ruleForm" :rules="rules" class="demo-ruleForm" ref="ruleForm">
      <el-form-item label="主键" prop="idToolCategory" v-if="false">
        <el-input clearable placeholder="请输入主键"
  ...
  <star-horse-dialog :is-view="true" :title="'查看数据'" :visible="viewVisible">
    <el-form :model="ruleForm" class="view-ruleForm" label-width="15%" ref="ruleForm">
      ...
      <el-form-item label="工具名称" prop="toolName">
        <span>{{ ruleForm.toolName }}</span>
      </el-form-item>
      <el-form-item label="工具编码" prop="toolCode">
        <span>{{ ruleForm.toolCode }}</span>
      </el-form-item>
      <el-form-item label="工具描述" prop="toolDesc">
        <span>{{ ruleForm.toolDesc }}</span>
      </el-form-item>
      <el-form-item label="发行版本" prop="toolVersion">
        <span>{{ ruleForm.toolVersion }}</span>
      </el-form-item>
      <el-form-item label="修改人" prop="updatedBy">
