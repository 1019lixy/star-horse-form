<template>
      ...
      >
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.idSafetyReport'" required>
              <el-input clearable placeholder="请输入主键"
                        v-model="scope.row.idSafetyReport"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.blocker'" required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.critical'" required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.major'" required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.minor'" required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.detailUrls'" required>
  ...
  <star-horse-dialog :title="dialogTitle" :visible="dialogTableVisible" @merge="merge" @mergeDraft="mergeDraft"
                     @reset="resetForm">
    <el-form :model="ruleForm" :rules="rules" class="demo-ruleForm" ref="ruleForm">
      <el-form-item label="主键" prop="idSafetyReport" v-if="false">
        <el-input clearable placeholder="请输入主键"
  ...
  <star-horse-dialog :is-view="true" :title="'查看数据'" :visible="viewVisible">
    <el-form :model="ruleForm" class="view-ruleForm" label-width="15%" ref="ruleForm">
      <el-form-item label="主键" prop="idSafetyReport">
        <span>{{ ruleForm.idSafetyReport }}</span>
      </el-form-item>
      <el-form-item label="主键" prop="idNodeProperty">
