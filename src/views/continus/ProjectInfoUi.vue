<template>
      ...
      >
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.idProjectInfo'" required>
              <el-input clearable placeholder="请输入主键"
                        v-model="scope.row.idProjectInfo"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.type'" required>
              <el-input clearable placeholder="请输入代码库类型"
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.host'" required>
              <el-input clearable placeholder="请输入代码库地址"
                        v-model="scope.row.host"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.port'" required>
              <el-input clearable placeholder="请输入代码库端口"
                        v-model="scope.row.port"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.projectName'" required>
              <el-input clearable placeholder="请输入项目名称"
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.projectCharset'" required>
              <el-input clearable placeholder="请输入项目编码"
                        v-model="scope.row.projectCharset"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.projectType'" required>
              <el-input clearable placeholder="请输入项目类型"
                        v-model="scope.row.projectType"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.account'" required>
              <el-input clearable placeholder="请输入流水线账号"
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.security'" required>
              <el-input clearable placeholder="请输入流水线密码"
                        v-model="scope.row.security"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
  ...
  <star-horse-dialog :title="dialogTitle" :visible="dialogTableVisible" @merge="merge" @mergeDraft="mergeDraft"
                     @reset="resetForm">
    <el-form :model="ruleForm" :rules="rules" class="demo-ruleForm" ref="ruleForm">
      <el-form-item label="主键" prop="idProjectInfo" v-if="false">
        <el-input clearable placeholder="请输入主键"
                  v-model="ruleForm.idProjectInfo"></el-input>
      </el-form-item>

      <el-form-item label="代码库类型" prop="type"
                    required v-if="!false">
        <el-input clearable placeholder="请输入代码库类型"
                  v-model="ruleForm.type"></el-input>
      </el-form-item>

      <el-form-item label="代码库地址" prop="host"
                    required v-if="!false">
        <el-input clearable placeholder="请输入代码库地址"
                  v-model="ruleForm.host"></el-input>
      </el-form-item>

      <el-form-item label="代码库端口" prop="port"
                    required v-if="!false">
        <el-input clearable placeholder="请输入代码库端口"
                  v-model="ruleForm.port"></el-input>
      </el-form-item>
      ...
      <el-form-item label="项目编码" prop="projectCharset"
                    required v-if="!false">
        <el-input clearable placeholder="请输入项目编码"
                  v-model="ruleForm.projectCharset"></el-input>
      </el-form-item>

      <el-form-item label="项目类型" prop="projectType"
                    required v-if="!false">
        <el-input clearable placeholder="请输入项目类型"
                  v-model="ruleForm.projectType"></el-input>
      </el-form-item>
      ...
      <el-form-item label="流水线账号" prop="account"
                    required v-if="!false">
        <el-input clearable placeholder="请输入流水线账号"
                  v-model="ruleForm.account"></el-input>
      </el-form-item>

      <el-form-item label="流水线密码" prop="security"
                    required v-if="!false">
        <el-input clearable placeholder="请输入流水线密码"
                  v-model="ruleForm.security"></el-input>
      </el-form-item>
  ...
  <star-horse-dialog :is-view="true" :title="'查看数据'" :visible="viewVisible">
    <el-form :model="ruleForm" class="view-ruleForm" label-width="15%" ref="ruleForm">
      <el-form-item label="主键" prop="idProjectInfo">
        <span>{{ ruleForm.idProjectInfo }}</span>
      </el-form-item>
      <el-form-item label="代码库类型" prop="type">
      ...
      <el-form-item label="项目编码" prop="projectCharset">
        <span>{{ ruleForm.projectCharset }}</span>
      </el-form-item>
      <el-form-item label="项目类型" prop="projectType">
        <span>{{ ruleForm.projectType }}</span>
      </el-form-item>
      <el-form-item label="程序语言" prop="language">
