<template>
      ...
      >
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.idEnvInfo'" :rules="rules.idEnvInfo"
                          required>
              <el-input clearable placeholder="请输入主键"
                        v-model="scope.row.idEnvInfo"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.envName'" :rules="rules.envName" required>
              <el-input clearable placeholder="请输入环境名称"
                        v-model="scope.row.envName"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.nevCode'" :rules="rules.nevCode" required>
              <el-input clearable placeholder="请输入环境编码"
                        v-model="scope.row.nevCode"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.envHose'" :rules="rules.envHose" required>
              <el-input clearable placeholder="请输入环境地址"
                        v-model="scope.row.envHose"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.envPort'" :rules="rules.envPort" required>
              <el-input clearable placeholder="请输入环境端口"
                        v-model="scope.row.envPort"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.envInitSpace'" :rules="rules.envInitSpace"
                          required>
              <el-input clearable placeholder="请输入初始空间大小"
                        v-model="scope.row.envInitSpace"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.envUsedSpace'" :rules="rules.envUsedSpace"
                          required>
              <el-input clearable placeholder="请输入已使用空间大小"
                        v-model="scope.row.envUsedSpace"></el-input>
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.expirationDate'" :rules="rules.expirationDate"
                          required>
        ...
        >
          <template #default="scope">
            <el-form-item :prop="'batchDataList.'+scope.$index+'.effectiveDate'" :rules="rules.effectiveDate"
                          required>
              <el-date-picker clearable placeholder="请选择生效时间"
                              type="date"
  ...
  <star-horse-dialog :title="dialogTitle" :visible="dialogTableVisible" @merge="merge" @mergeDraft="mergeDraft"
                     @reset="resetForm">
    <el-form :model="ruleForm" :rules="rules" class="demo-ruleForm" ref="ruleForm">
      <el-form-item label="主键" prop="idEnvInfo" v-if="false">
        <el-input clearable placeholder="请输入主键"
                  v-model="ruleForm.idEnvInfo"></el-input>
      </el-form-item>

      <el-form-item label="环境名称" prop="envName"
                    required v-if="!false">
        <el-input clearable placeholder="请输入环境名称"
                  v-model="ruleForm.envName"></el-input>
      </el-form-item>

      <el-form-item label="环境编码" prop="nevCode"
                    required v-if="!false">
        <el-input clearable placeholder="请输入环境编码"
                  v-model="ruleForm.nevCode"></el-input>
      </el-form-item>

      <el-form-item label="环境地址" prop="envHose"
                    required v-if="!false">
        <el-input clearable placeholder="请输入环境地址"
                  v-model="ruleForm.envHose"></el-input>
      </el-form-item>

      <el-form-item label="环境端口" prop="envPort"
                    required v-if="!false">
        <el-input clearable placeholder="请输入环境端口"
                  v-model="ruleForm.envPort"></el-input>
      </el-form-item>

      <el-form-item label="初始空间大小" prop="envInitSpace"
                    required v-if="!false">
        <el-input clearable placeholder="请输入初始空间大小"
                  v-model="ruleForm.envInitSpace"></el-input>
      </el-form-item>

      <el-form-item label="已使用空间大小" prop="envUsedSpace"
                    required v-if="!false">
        <el-input clearable placeholder="请输入已使用空间大小"
                  v-model="ruleForm.envUsedSpace"></el-input>
      </el-form-item>
      ...
      <el-form-item label="生效时间" prop="effectiveDate"
                    required v-if="!false">
        <el-date-picker clearable placeholder="请选择生效时间" type="date"
  ...
  <star-horse-dialog :is-view="true" :title="'查看数据'" :visible="viewVisible">
    <el-form :model="ruleForm" class="view-ruleForm" label-width="15%" ref="ruleForm">
      <el-form-item label="主键" prop="idEnvInfo">
        <span>{{ ruleForm.idEnvInfo }}</span>
      </el-form-item>
      <el-form-item label="环境名称" prop="envName">
        <span>{{ ruleForm.envName }}</span>
      </el-form-item>
      <el-form-item label="环境编码" prop="nevCode">
        <span>{{ ruleForm.nevCode }}</span>
      </el-form-item>
      <el-form-item label="环境地址" prop="envHose">
        <span>{{ ruleForm.envHose }}</span>
      </el-form-item>
      <el-form-item label="环境端口" prop="envPort">
        <span>{{ ruleForm.envPort }}</span>
      </el-form-item>
      <el-form-item label="初始空间大小" prop="envInitSpace">
        <span>{{ ruleForm.envInitSpace }}</span>
      </el-form-item>
      <el-form-item label="已使用空间大小" prop="envUsedSpace">
        <span>{{ ruleForm.envUsedSpace }}</span>
      </el-form-item>
      <el-form-item label="失效日期" prop="expirationDate">
        <span>{{ ruleForm.expirationDate }}</span>
      </el-form-item>
      <el-form-item label="生效时间" prop="effectiveDate">
