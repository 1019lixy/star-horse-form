...
import {apiInstance, closeLoad, download, error, load, warning,} from "star-horse-lowcode";
  ...
  <el-tabs class="h-full query-result-tabs" type="border-card" v-model="activeName">
    ...
    >
      <div class="flex items-center justify-between result-controls">
        ...
        <el-button :size="compSize" @click="exportData(item)" type="info" plain class="export-btn">
