...
import {SelectOption, FieldInfo, PageFieldInfo, TabFieldInfo, httpMethod} from "star-horse-lowcode";
...
const storeFields = reactive<Array<FieldInfo>>([assignee, candidateUsers, candidateRoles]);
