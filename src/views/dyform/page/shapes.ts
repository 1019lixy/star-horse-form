export const SHAPE_PATH_FORMULAS = {
    ...
    ROUND_RECT_DIAGONAL: {
        ...
        formula: (width: number, height: number, value: number) => {
            ...
            return `M 0 0 L ${
                width - radius
            } 0 Q ${width} 0 ${width} ${radius} L ${width} ${height} L ${radius} ${height} Q 0 ${height} 0 ${
                height - radius
            } L 0 0 Z`;
        }
    },
    ...
    ROUND_MESSAGE: {
        formula: (width: number, height: number) => {
            ...
            const arrowWidth = width * 0.2;
            const arrowheight = height * 0.2;
            return `M 0 ${radius} Q 0 0 ${radius} 0 L ${width - radius} 0 Q ${width} 0 ${width} ${radius} L ${width} ${
                height - radius - arrowheight
            } Q ${width} ${height - arrowheight} ${width - radius} ${
                height - arrowheight
            } L ${width / 2} ${height - arrowheight} L ${width / 2 - arrowWidth} ${height} L ${width / 2 - arrowWidth} ${
                height - arrowheight
 ...
 * SVG 图形
 */
export const SHAPE_LIST: ShapeItem[] = [
    {
        type: "矩形",
        children: [
            {
...

    {
        ...
        children: [
            ...
            },
            {
                ...
                pathFormula: SHAPE_PATH_FORMULAS.TRIANGLE
            },
            {
                viewBox: [200, 200],
            ...
            },
            {
                ...
                pathFormula: SHAPE_PATH_FORMULAS.PARALLELOGRAM_LEFT
            },
            {
                viewBox: [200, 200],
                path: "M 0 0 L 150 0 L 200 200 L 50 200 L 0 0 Z",
                pathFormula: SHAPE_PATH_FORMULAS.PARALLELOGRAM_RIGHT
            },
            {
                viewBox: [200, 200],
                path: "M 50 0 L 150 0 L 200 200 L 0 200 L 50 0 Z",
                pathFormula: SHAPE_PATH_FORMULAS.TRAPEZOID
            },
            {
                viewBox: [200, 200],
            ...
            },
            {
                ...
                pathFormula: SHAPE_PATH_FORMULAS.BULLET
            },
            {
                viewBox: [200, 200],
                path: "M 200 100 L 150 0 L 0 0 L 50 100 L 0 200 L 150 200 L 200 100 Z",
                pathFormula: SHAPE_PATH_FORMULAS.INDICATOR
            },
            {
                viewBox: [200, 200],
            ...
            },
            {
                ...
                pathFormula: SHAPE_PATH_FORMULAS.L
            },
            {
                viewBox: [200, 200],
                path: "M0 0 L200 0 L200 200 L0 200 L0 0 Z M50 50 L50 150 L150 150 L150 50 Z",
                pathFormula: SHAPE_PATH_FORMULAS.RING_RECT
            },
            {
                viewBox: [200, 200],
            ...
            },
            {
                ...
                pathFormula: SHAPE_PATH_FORMULAS.PLUS
            },
            {
                viewBox: [200, 200],
            ...
            },
            {
                ...
                pathFormula: SHAPE_PATH_FORMULAS.MESSAGE
            },
            {
                viewBox: [200, 200],
                ...
                pathFormula: SHAPE_PATH_FORMULAS.ROUND_MESSAGE
            },
            {
                viewBox: [200, 200],
 ...
 * 图标图形
 */
export const CHART_LIST: ShapeItem[] = [
    {
        type: "柱状图",
        children: []
    },
        ...
        children: [
            {
                viewBox: [200, 200],
                title: "折线图",
                path: "50,150 100,100 150,120 200,80 250,130 300,70 350,100"
            },
            {
                viewBox: [200, 200],
                title: "曲线图",
                path: "M50,150 C100,100 200,100 300,150 C350,200 350,200 350,150"
            }
        ]
    },
    {
