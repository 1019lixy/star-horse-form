<script setup lang="ts">
  ...
  import {apiInstance, dialogPreps,SearchFields,PageFieldInfo,ApiUrls,createDatetime} from "star-horse-lowcode";
  import {getCustomerParam} from "@/utils/auth";
  defineOptions({
    name: 'DynamicScriptColumns',
  })
  //后端交互接口地址
  const dataUrl: ApiUrls = apiInstance("userdb-manage", "userdb/dynamicScriptColumns");
  //主键
...
<template>
  <star-horse-dialog :isShowBtnContinue="true" :dialog-visible="dialogProps.editVisible" :dialogProps="dialogProps">
    <star-horse-form  @refresh="dynamicScriptColumnsRef?.loadByPage()"  @dataLoaded="dataLoaded" :compUrl="dataUrl"
  ...
  <div class="search-content">
    <div class="search_btn">
      <star-horse-search-comp
          @searchData="(data: any) => dynamicScriptColumnsRef?.createSearchParams(data)"
  ...
  <el-card class="inner_content">
    <star-horse-table-comp  ref = "dynamicScriptColumnsRef" :fieldList="tableFieldList" :primaryKey="primaryKey"
                            :compUrl="dataUrl"
