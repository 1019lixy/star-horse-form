...
let formInfo = inject("formInfo") as any;
...
<template>
  ...
  >
    ...
    <el-tabs type = "border-card" v-model = "formActiveNames">
      ...
      <el-row>
        <el-col :span="12"><el-form-item label = "行内表单模式" prop = "inline">
          <el-switch
              :active-value = "'yes'"
              :inactive-value = "'no'"
              active-text = "是"
        ...
        <el-col :span="12"><el-form-item label = "是否禁用该表单内的所有组件" prop = "disabled">
          <el-switch
              :active-value = "'yes'"
              :inactive-value = "'no'"
              active-text = "是"
        ...
        <el-row>
          ...
          <el-col :span="12"><el-form-item label = "当校验失败时，滚动到第一个错误表单项" prop = "scrollToError">
            <el-switch
                :active-value = "'yes'"
                :inactive-value = "'no'"
                active-text = "是"
        ...
        <el-row>
          <el-col :span="12"> <el-form-item label = "星号的位置" prop = "requireAsteriskPosition">
            <el-switch
                :active-value = "'left'"
          ...
          <el-col :span="12"><el-form-item label = "是否在输入框中显示校验结果反馈图标" prop = "statusIcon">
            <el-switch
                :active-value = "'yes'"
                :inactive-value = "'no'"
                active-text = "是"
        ...
        <el-row>
          <el-col :span="12"><el-form-item label = "是否显示校验错误信息" prop = "showMessage">
            <el-switch
                :active-value = "'yes'"
                :inactive-value = "'no'"
                active-text = "是"
          ...
          <el-col :span="12"><el-form-item label = "是否以行内形式展示校验信息" prop = "inlineMessage">
            <el-switch
                :active-value = "'yes'"
                :inactive-value = "'no'"
                active-text = "是"
