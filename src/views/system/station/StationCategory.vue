...
<template>
  ...
  <star-horse-dialog :dialog-visible="dialogProps.viewVisible" :dialogProps="dialogProps"
                     :isView="true"
                     :title="'查看数据'">
  ...
  <el-card class="inner_content">
    <div :style="{'flex-direction':Config.buttonStyle=='line'?'column':'row'}" class="search_btn">
      <star-horse-search-comp :compUrl="dataUrl"
    ...
    <hr/>
    <star-horse-table-comp ref="stationSequenceRef" :compUrl="dataUrl" :dataFormat="dataFormat"
