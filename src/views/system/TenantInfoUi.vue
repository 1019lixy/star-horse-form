...
const tableFieldList = reactive<PageFieldInfo | any>({
  'fieldList': [[{'label': '租户名称', 'fieldName': 'tenantName', 'type': 'input', 'required': true, 'formVisible': true, 'listVisible': true, 'preps': {}}, {'label': '租户编码', 'fieldName': 'tenantCode', 'type': 'input',editDisabled:'Y', 'required': true, 'formVisible': true, 'listVisible': true, 'preps': {}}], [{'label': '联系人', 'fieldName': 'linkMan', 'type': 'input', 'required': true, 'formVisible': true, 'listVisible': true, 'preps': {}}, {'label': '联系电话', 'fieldName': 'phone', 'type': 'input', 'required': true, 'formVisible': true, 'listVisible': true, 'preps': {}}],
