  ...
  <div class="instance-item">
    <div class="item-bar" v-if="showHeaderBar">
      <div class="item-bar-left">
        ...
        <el-divider direction="vertical"/>
        <span>总耗时：{{ instanceInfo.totalTimes || 0 }}s</span>
        <el-divider direction="vertical"/>
        <span>#{{ instanceInfo.dataIndex || nodeInfo.dataNo }}</span>
      </div>
      <div class="item-bar-right" v-if="Object.keys(instanceInfo||{}).length==0">
        <ul class="nav_ul">
          <li>
