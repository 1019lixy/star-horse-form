...
></div>
      ...
      <div
          class="relative md:flex md:items-center md:justify-center sm:w-auto md:h-full md:w-2/5 xl:w-2/5 p-8 md:p-10 lg:p-14 flex-col sm:rounded-lg md:rounded-none bg-white"
      >
        <div class="absolute top-4 right-4">
          <Locale style="z-index:999999" color="#000"/>
        </div>
        <div
        ...
        >
          ...
          <div class="flex flex-row justify-center items-center space-x-3">
            ...
            >
              <img
                  class="w-4 h-4"
                  src="data:image/svg+xml;base64,"
              />
            </div>
            <div
                @click="otherLogin('qq')"
