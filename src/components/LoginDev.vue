  ...
  <div class="relative min-h-screen flex">
    <div
      ...
      <div
        ...
        <vue-particles id="tsparticles" @particlesLoaded="particlesLoaded" :options="particlesCfg" />
        ...
        <div class="w-full max-w-2xl z-10">
          ...
          <div class="sm:text-sm xl:text-md text-gray-200 font-normal" style="font-size: 14px; line-height: 30px">
      ...
      <div class="md:flex md:items-center
        ...
        <div class="w-xl space-y-8 relative" style="position: relative; background: #fff">
          ...
          <el-form :model="loginForm" :rules="loginRules" :size="'large'" class="mt-8 space-y-6" label-position="top"
            ref="loginFormRef">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-button link :size="Config.compSize" class="items-center justify-center">
                  {{ i18n("login.forget") }}
                </el-button>
              </el-col>
            </el-row>
            <el-form-item class="h-50">
              <el-button :loading="loading" @click.stop="handleLogin(loginFormRef, $event)"
            ...
            <div class="flex items-center justify-center mt-10 text-center text-md text-gray-500">
        ...
        <div class="copyright items-center justify-center" style="position: absolute; bottom: 5px">
