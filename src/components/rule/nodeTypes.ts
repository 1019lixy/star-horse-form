            ...
            },
            {
                ...
                paramSchema: [
                    ...
                    },
                    {
                        ...
                        type: 'input',
                        placeholder: 'rule.ph.items',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'itemVar',
                        label: 'rule.lbl.itemVar',
                        type: 'input',
                        default: 'item',
                        group: 'rule.group.basic'
                    },
        ...
        nodes: [
            ...
            },
            {
                ...
                paramSchema: [
                    ...
                    {
                        name: 'responseVar',
                        label: 'rule.lbl.responseVar',
                        type: 'input',
                        placeholder: 'rule.ph.responseVar',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'timeout',
                        label: 'rule.lbl.timeout',
                        type: 'number',
                        min: 1000,
                        default: 5000,
                        group: 'rule.group.advanced'
                    },
                    {
                        name: 'retryCount',
                        label: 'rule.lbl.retryCount',
                        type: 'number',
                        min: 0,
                        max: 5,
                        default: 0,
            ...
            },
            {
                ...
                paramSchema: [
                    {
                        name: 'ruleSetCode',
                        label: 'rule.lbl.ruleSetCode',
                        type: 'input',
                        required: true,
                        placeholder: 'rule.ph.orderValidation',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'ruleSetName',
                        label: 'rule.lbl.ruleSetName',
                        type: 'input',
                        placeholder: 'rule.ph.optionalDesc',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'inputMapping',
                        label: 'rule.lbl.inputMapping',
                        type: 'textarea',
                        rows: 3,
                        placeholder: 'rule.ph.inputMapping',
                        group: 'rule.group.mapping'
                    },
                    {
                        name: 'outputMapping',
                        label: 'rule.lbl.outputMapping',
                        type: 'textarea',
                        rows: 3,
                        placeholder: 'rule.ph.outputMapping',
                        group: 'rule.group.mapping'
                    },
                ]
            },
            {
                ...
                paramSchema: [
                    {
                        name: 'tableName',
                        label: 'rule.lbl.tableName',
                        type: 'input',
                        required: true,
                        placeholder: 'rule.ph.discountTable',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'conditions',
                        label: 'rule.lbl.conditionColumns',
                        type: 'table',
                        group: 'rule.group.condition',
                        columns: [
                            {prop: 'fieldName', label: 'rule.lbl.fieldName', type: 'input', width: '120px'},
        ...
        nodes: [
            ...
            },
            {
                ...
                paramSchema: [
                    {
                        name: 'sourceType',
                        label: 'rule.lbl.datasourceType',
                        type: 'select',
                        required: true,
                        options: [{label: 'REST API', value: 'API'}, {
                            label: () => i18n('rule.opt.dbQuery'),
                            value: 'DB'
                        }, {label: () => i18n('rule.opt.redisCache'), value: 'REDIS'}],
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'method',
                        label: 'rule.lbl.httpMethod',
                        type: 'select',
                    ...
                    },
                    {
                        ...
                        type: 'input',
                        required: true,
                        placeholder: 'rule.ph.stockData',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'cacheEnabled',
                        label: 'rule.lbl.enableCache',
                        type: 'switch',
                        default: 'Y',
                        group: 'rule.group.cache'
                    },
                    {
                        name: 'cacheTTL',
                        label: 'rule.lbl.cacheTTL',
                        type: 'number',
                        min: 0,
                        default: 300,
                        group: 'rule.group.cache'
        ...
        nodes: [
            {
                ...
                paramSchema: [
                    ...
                    {
                        name: 'matchType',
                        label: 'rule.lbl.matchType',
                        type: 'select',
                        required: true,
                        options: [{
                            label: () => i18n('rule.opt.enumMatch'),
                            value: 'ENUM'
                ...
                paramSchema: [
                    {
                        ...
                        type: 'input',
                        required: true,
                        placeholder: 'rule.ph.sourceVar',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'dictCode',
                        label: 'rule.lbl.dictCode',
                        type: 'input',
                        required: true,
        ...
        nodes: [
            ...
            },
            {
                ...
                paramSchema: [
                    ...
                    {
                        name: 'groupFields',
                        label: 'rule.lbl.groupFields',
                        type: 'input',
                        placeholder: 'rule.ph.groupFields',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'aggFields',
                        label: 'rule.lbl.aggFields',
                        type: 'input',
                        placeholder: 'rule.ph.aggFields',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'targetVar',
        ...
        nodes: [
            {
                ...
                paramSchema: [
                    ...
                    {
                        name: 'targetUsers',
                        label: 'rule.lbl.targetUsers',
                        type: 'input',
                        placeholder: 'rule.ph.targetUsers',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'title',
                        label: 'rule.lbl.title',
                        type: 'input',
                        required: true,
        ...
        nodes: [
            {
                ...
                paramSchema: [
                    ...
                    },
                    {
                        ...
                        type: 'input',
                        required: true,
                        placeholder: 'rule.ph.apiUrl',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'timeout',
                        label: 'rule.lbl.timeoutMs',
                        type: 'number',
                        min: 1000,
                        step: 1000,
                        default: 5000,
        ...
        nodes: [
            {
                ...
                paramSchema: [
                    {
                        name: 'degradeCondition',
                        label: 'rule.lbl.degradeCondition',
                        type: 'select',
                        required: true,
                        options: [
                    ...
                    {
                        name: 'fallbackAction',
                        label: 'rule.lbl.fallbackAction',
                        type: 'textarea',
                        rows: 2,
                        placeholder: 'rule.ph.fallbackAction',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'description',
            ...
            },
            {
                ...
                paramSchema: [
                    ...
                    {
                        name: 'handlerAction',
                        label: 'rule.lbl.handlerAction',
                        type: 'textarea',
                        rows: 2,
                        placeholder: 'rule.ph.handlerAction',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'description',
            ...
            },
            {
                ...
                paramSchema: [
                    ...
                    {
                        name: 'message',
                        label: 'rule.lbl.terminateMsg',
                        type: 'textarea',
                        rows: 2,
                        required: true,
                        placeholder: 'rule.ph.terminateMsg',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'description',
        ...
        nodes: [
            {
                ...
                paramSchema: [
                    {
                        name: 'fields',
                        label: 'rule.lbl.desensitizeFields',
                        type: 'input',
                        required: true,
                    ...
                    },
                    {
                        ...
                        label: 'rule.lbl.desensitizeType',
                        type: 'select',
                        required: true,
                        options: [
            ...
            },
            {
                ...
                paramSchema: [
                    {
                        name: 'dataSource',
                        label: 'rule.lbl.dataSourceVar',
                        type: 'input',
                        required: true,
                        placeholder: 'rule.ph.dataSourceVar',
                        group: 'rule.group.basic'
                    },
                    {
        ...
        nodes: [
            {
                ...
                paramSchema: [
                    {
                        name: 'subRuleCode',
                        label: 'rule.lbl.subRuleCode',
                        type: 'input',
                        required: true,
                        placeholder: 'rule.ph.subRuleCode',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'subRuleName',
                        label: 'rule.lbl.subRuleName',
                        type: 'input',
                        placeholder: 'rule.ph.subRuleName',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'inputMapping',
            ...
            },
            {
                ...
                paramSchema: [
                    {
                        name: 'ruleCode',
                        label: 'rule.lbl.ruleCode',
                        type: 'input',
                        required: true,
                        placeholder: 'rule.ph.ruleCode',
                        group: 'rule.group.basic'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        label: 'rule.lbl.specifiedVersion',
                        type: 'input',
                        placeholder: 'rule.ph.specifiedVersion',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'description',
            ...
            },
            {
                ...
                paramSchema: [
                    ...
                    {
                        name: 'grayField',
                        label: 'rule.lbl.grayField',
                        type: 'input',
                        placeholder: 'rule.ph.grayField',
                        group: 'rule.group.basic'
                    },
                    {
                        name: 'description',
