...
<template>
      ...
      >
        ...
        <template #tip>
          <div class="el-upload__tip">
            只能上传 xls/xlsx 文件类型
            <el-button @click="downloadTemplate" title="" :size="size" link v-if="importInfo?.downloadTemplateUrl">
  ...
  <div class="form-list">
    ...
    >
      <el-table-column type="selection" fixed="left" width="50" align="center" v-if="false" />
      <el-table-column label="序号" align="center" prop="xh" width="50" />
      <el-table-column prop="" label="排序" width="60" v-if="staticColumn == 'N'">
        <template #default="scope">
          <el-tag class="move" style="cursor: move" @mousedown="selectData(scope.row)">
