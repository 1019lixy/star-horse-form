<template>
  ...
  >
    <div class="number-range-container">
      <div v-if="field.preps['prefix']" :class="{ 'slot-default': slotStyle === 'default', 'slot-pend ': true }">
        {{ field.preps["prefix"] }}
      </div>
      <div
        class="number-range"
      ...
      <div v-if="field.preps['suffix']" :class="{ 'slot-default': slotStyle === 'default', 'slot-pend ': true }">
        {{ field.preps["suffix"] }}
      </div>
    </div>
  </starhorse-form-item>
