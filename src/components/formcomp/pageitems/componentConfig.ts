        ...
        properties: [
            ...
            },
            {
                ...
                options: [
                    ...
                    {label: "带总数", value: "total, prev, pager, next"},
                ],
            },
            {
                name: "pageSizes",
    ...
    "ppageheader-item": {
        ...
        properties: [
            ...
            },
            {
                ...
                label: "面包屑",
                type: "json",
                defaultValue: [{path: "/", label: "首页"}, {label: "当前页面"}],
                isComplex: true,
                complexType: "array",
                description: "面包屑配置",
            },
