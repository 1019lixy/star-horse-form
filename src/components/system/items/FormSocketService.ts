...
export class FormSocketService {
    ...
    public subscribeToPeerJoined(callback: (message: any) => void, userId: string): string | null {
        ...
        try {
            ...
            const subscription = this.stompClient.subscribe(`/form/${userId}/peer-joined`, (message) => {
    ...
    public subscribeToExistingPeers(callback: (message: any) => void, userId: string): string | null {
        ...
        try {
            ...
            const subscription = this.stompClient.subscribe(`/form/${userId}/existing-peers`, (message) => {
     ...
     * @param callback
     */
    public subscribeToGroupMessages(callback: (message: any) => void, formId: string): string | null {
        if (!this.stompClient || !this.connected) {
            console.error("Chat WebSocket not connected");
            return null;
        }
    ...
    public lockComponent(compId: string, formId: string, userInfo: any): void {
        ...
        try {
            ...
            this.stompClient.send("/app/form/lock-component", {}, JSON.stringify(payload));
    ...
    public unlockComponent(compId: string, formId: string): void {
        ...
        try {
            ...
            this.stompClient.send("/app/form/unlock-component", {}, JSON.stringify(payload));
