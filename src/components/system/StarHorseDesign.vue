<script setup lang="ts" name="StarHorseDesign">
  ...
  import { CompInfo, CustomerItem, NodeInfo } from "star-horse-lowcode";
  ...
  import { closeLoad, formFieldMapping, load } from "star-horse-lowcode";
  ...
  import { useConsumerViewStore } from "star-horse-lowcode";
